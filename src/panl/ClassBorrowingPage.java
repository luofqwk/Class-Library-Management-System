...
public class ClassBorrowingPage {
       private JPanel panel_7;
       private JPanel panel_5;
       String account;
       private int page=1;//定义当前页数
    public ClassBorrowingPage(String account,JPanel panel_7,JPanel panel_5){
    ...
    void init(){
           //数量多少 每页5个
           String sql="SELECT count(*) from BorrowRecord  ,Class  where Class.ClassAdminUsername=?; ";
            ...
            if(rst.next()){
                ...
                if(count<=2){
                    ...
                    btnNewButton_41.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                String sql22="SELECT ClassMemberName,Title,Author,Bookwordcount from BorrowRecord inner join ClassMember on ClassMember.ClassMemberID=BrrownumberID inner join BookInfo on BookInfo.BookID=BrrowbookID where ClassMember.ClassMemberclass=(Select ClassAdminclass from Class where ClassAdminUsername=?) ORDER BY RecordID OFFSET 5 ROWS  FETCH NEXT 5 ROWS ONLY;";                     
                    ...
                    btnNewButton_6.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                            ...
                            JOptionPane.showMessageDialog(null, "当前已为第一页");  
                                ...
                                String sql2="SELECT ClassMemberName,Title,Author,Bookwordcount from BorrowRecord inner join ClassMember on ClassMember.ClassMemberID=BrrownumberID inner join BookInfo on BookInfo.BookID=BrrowbookID where ClassMember.ClassMemberclass=(Select ClassAdminclass from Class where ClassAdminUsername=?) ORDER BY  RecordID OFFSET "+strline+" ROWS  FETCH NEXT 5 ROWS ONLY";                      
                                ResultSet rst2=null;
                                PreparedStatement pst2=null;
                                try{
                                Connection conn1=null;
                    ...
                    btnNewButton_10.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                ...
                                String sql2="SELECT ClassMemberName,Title,Author,Bookwordcount from BorrowRecord inner join ClassMember on ClassMember.ClassMemberID=BrrownumberID inner join BookInfo on BookInfo.BookID=BrrowbookID where ClassMember.ClassMemberclass=(Select ClassAdminclass from Class where ClassAdminUsername=?) ORDER BY  RecordID OFFSET "+strline1+" ROWS  FETCH NEXT 5 ROWS ONLY";                      
                                ResultSet rst2=null;
                                PreparedStatement pst2=null;
                                try{
                                Connection conn1=null;

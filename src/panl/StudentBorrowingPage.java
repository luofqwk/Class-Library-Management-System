...
public class StudentBorrowingPage {
       private JPanel panel_7;
       private JPanel panel_5;
       String account;
       String searchID;
       private int page=1;//定义当前页数
    public StudentBorrowingPage(String account,JPanel panel_7,JPanel panel_5,String searchID){
    ...
    void init(){
           //数量多少 每页5个
           String sql="SELECT count(*) from BorrowRecord ,Class  where Class.ClassAdminUsername=? and BrrownumberID=?; ";
            ...
            if(rst.next()){
                ...
                if(count<=2){
                    ...
                    btnNewButton_41.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                String sql22="SELECT ClassMemberName,Title,Author,Bookwordcount from BorrowRecord inner join ClassMember on ClassMember.ClassMemberID=BrrownumberID inner join BookInfo on BookInfo.BookID=BrrowbookID where ClassMember.ClassMemberclass=(Select ClassAdminclass from Class where ClassAdminUsername=?) and BrrownumberID=? ORDER BY RecordID OFFSET 5 ROWS  FETCH NEXT 5 ROWS ONLY;";                     
                    ...
                    btnNewButton_6.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                            ...
                            JOptionPane.showMessageDialog(null, "当前已为第一页");  
                                ...
                                String sql2="SELECT ClassMemberName,Title,Author,Bookwordcount from BorrowRecord inner join ClassMember on ClassMember.ClassMemberID=BrrownumberID inner join BookInfo on BookInfo.BookID=BrrowbookID where ClassMember.ClassMemberclass=(Select ClassAdminclass from Class where ClassAdminUsername=?)  and BrrownumberID=? ORDER BY  RecordID OFFSET "+strline+" ROWS  FETCH NEXT 5 ROWS ONLY";                      
                                ResultSet rst2=null;
                                PreparedStatement pst2=null;
                                try{
                                Connection conn1=null;
                    ...
                    btnNewButton_10.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                ...
                                String sql2="SELECT ClassMemberName,Title,Author,Bookwordcount from BorrowRecord inner join ClassMember on ClassMember.ClassMemberID=BrrownumberID inner join BookInfo on BookInfo.BookID=BrrowbookID where ClassMember.ClassMemberclass=(Select ClassAdminclass from Class where ClassAdminUsername=?)  and BrrownumberID=? ORDER BY  RecordID OFFSET "+strline1+" ROWS  FETCH NEXT 5 ROWS ONLY";                      
                                ResultSet rst2=null;
                                PreparedStatement pst2=null;
                                try{
                                Connection conn1=null;
    ...
    public void upstock(ResultSet rs1){
                ...
                try  {
                    panel_5.removeAll();
                    while (rs1.next() ) {  
                        String studentname=rs1.getString("ClassMemberName");
                        String Bookname=rs1.getString("Title");
                        String author=rs1.getString("Author");
                        int Bookwordcount=rs1.getInt("Bookwordcount");
                        ClassBorrowingStock text=new ClassBorrowingStock(studentname,Bookname,author,Bookwordcount,panel_5,account);
                        SwingUtilities.updateComponentTreeUI(panel_5);
                        }
                        rs1.close();

...
public class BookquantityPage{
       private JPanel panel_7;
       private JPanel panel_5;
       String account;
       private int page=1;//定义当前页数
       String searchbook;
    public BookquantityPage(String account,JPanel panel_7,JPanel panel_5,String searchbook){
    ...
    public void upstock(ResultSet rs1){
                ...
                try  {
                    ...
                    while (rs1.next() ) {  
                        ...
                        BookquantityStock text=new BookquantityStock(BookID,Bookname,author,category,stocknumber,panel_5,account);
                        SwingUtilities.updateComponentTreeUI(panel_5);
                        }
                        rs1.close();

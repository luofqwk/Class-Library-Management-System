...
public class BookcategoryPage{
       ...
       String searchbook;
    public BookcategoryPage(String account,JPanel panel_7,JPanel panel_5,String searchbook){
    ...
    void init(){
           String sql="SELECT count(*) from BookInfo ,ClassMember where ClassMember.ClassMemberName=? and Category =?";
                ...
                if(count<=2){
                    ...
                    btnNewButton_4.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                String sql2="SELECT * FROM BookInfo ,ClassMember where ClassMember.ClassMemberName = ? and Category =? ORDER BY BookInfo.BookID OFFSET 0 ROWS  FETCH NEXT 5 ROWS ONLY";                      
                                ResultSet rst2=null;
                    ...
                    btnNewButton_41.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                String sql22="SELECT * FROM BookInfo ,ClassMember where ClassMember.ClassMemberName = ? and Category = ? ORDER BY BookInfo.BookID OFFSET 5 ROWS  FETCH NEXT 5 ROWS ONLY";                     
                    ...
                    btnNewButton_6.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                            ...
                            JOptionPane.showMessageDialog(null, "当前已为第一页");  
                                ...
                                String sql2="SELECT * FROM BookInfo ,ClassMember where ClassMember.ClassMemberName = ? and Category =? ORDER BY BookInfo.BookID OFFSET "+strline+" ROWS  FETCH NEXT 5 ROWS ONLY";                      
                                ResultSet rst2=null;
                                PreparedStatement pst2=null;
                                try{
                                Connection conn1=null;
                    ...
                    btnNewButton_10.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                ...
                                String sql2="SELECT * FROM BookInfo ,ClassMember where ClassMember.ClassMemberName = ? and Category =? ORDER BY BookInfo.BookID OFFSET "+strline1+" ROWS  FETCH NEXT 5 ROWS ONLY";                      
                                ResultSet rst2=null;
                                PreparedStatement pst2=null;
                                try{
                                Connection conn1=null;
    ...
    public void upstock(ResultSet rs1){
                ...
                try  {
                    ...
                    while (rs1.next() ) {  
                        ...
                        BookcategoryStock text=new BookcategoryStock(BookID,Bookname,author,category,stocknumber,panel_5,account);
                        SwingUtilities.updateComponentTreeUI(panel_5);
                        }
                        rs1.close();

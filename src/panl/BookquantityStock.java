...
public class BookquantityStock {
	   private JPanel panel_5;
	   private String account;
      public BookquantityStock(String BookID,String Bookname,String author,String category,int Borrownumber,JPanel panel_5,String searchbook){
        //初始化	

...
public class PageBU {
    ...
    public PageBU(String account,JPanel panel_7,JPanel panel_5){
    ...
    void init(){
           //数量多少 每页5个
           String sql="SELECT count(*) from BookInfo ,ClassMember where ClassMember.ClassMemberName=? ";
                ...
                if(count<=2){
                    ...
                    btnNewButton_4.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                String sql2="SELECT * FROM BookInfo ,ClassMember where ClassMember.ClassMemberName = ? ORDER BY BookInfo.BookID OFFSET 0 ROWS  FETCH NEXT 5 ROWS ONLY";                      
                                ResultSet rst2=null;
                    ...
                    btnNewButton_41.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                String sql22="SELECT * FROM BookInfo ,ClassMember where ClassMember.ClassMemberName = ? ORDER BY BookInfo.BookID OFFSET 5 ROWS  FETCH NEXT 5 ROWS ONLY";                     
                    ...
                    btnNewButton_6.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                            ...
                            JOptionPane.showMessageDialog(null, "当前已为第一页");  
                                ...
                                String sql2="SELECT * FROM BookInfo ,ClassMember where ClassMember.ClassMemberName = ? ORDER BY BookInfo.BookID OFFSET "+strline+" ROWS  FETCH NEXT 5 ROWS ONLY";                      
                                ResultSet rst2=null;
                                PreparedStatement pst2=null;
                                try{
                                Connection conn1=null;
                    ...
                    btnNewButton_10.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                                ...
                                String sql2="SELECT * FROM BookInfo ,ClassMember where ClassMember.ClassMemberName = ? ORDER BY BookInfo.BookID OFFSET "+strline1+" ROWS  FETCH NEXT 5 ROWS ONLY";                      
                                ResultSet rst2=null;
                                PreparedStatement pst2=null;
                                try{
                                Connection conn1=null;

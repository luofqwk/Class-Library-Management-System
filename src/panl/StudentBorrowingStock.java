...
public class StudentBorrowingStock {
	   private JPanel panel_5;
	   private String account;
      public  StudentBorrowingStock(String studentname,String Bookname,String author,int Bookwordcount,JPanel panel_5,String searchbook){
        //初始化	
